...
module.exports.config = {
  ...
  discovery: {
    service_documentation: 'myhomeurl',
    version: [
      '1.0.0',
  ...
  interactionUrl: function interactionUrl(ctx, interaction) { // eslint-disable-line no-unused-vars
    ...
    // return `/authn/authlogin/${ctx.oidc.uuid}`;   ///authn/authlogin/:uuid
  },
...
module.exports.clients = [
  {
    ...
    redirect_uris: ['https://cosmaze-idp.cosmaze.org:3443/msgapi/messages/public1'],
  ...
  },
  {
    ...
    redirect_uris: ['https://cosmaze-idp.cosmaze.org:6443/cb'],
  ...
  },
  {
    ...
    post_logout_redirect_uris: [
      'https://cosmaze-idp.cosmaze.org:6443'
    ],
    backchannel_logout_session_required: false,
    frontchannel_logout_session_required: false,
    request_uris: [],
    web_message_uris: [],
    client_id_issued_at: 1533213233,
    client_id: 'manoj-client-id',
    client_secret_expires_at: 0,
    client_secret: 'manoj-client-secret',
    redirect_uris: [
      'https://cosmaze-idp.cosmaze.org:3443/msgapi/callback',
    ],
    introspection_endpoint_auth_method: 'client_secret_basic',
    revocation_endpoint_auth_method: 'client_secret_basic',
    registration_client_uri: 'https://cosmaze-idp.cosmaze.org:3443/reg/d9a6a18f-b4f1-464a-9667-d1b296bc783e',
    registration_access_token: '5mPxhzmHjdYOycnRntHOejaUHkj8TomBsykEw9zOJSU'
  },
];
