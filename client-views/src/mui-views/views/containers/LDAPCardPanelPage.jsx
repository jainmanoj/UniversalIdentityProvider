...
class LDAPCardPanelPage extends React.Component {
  ...
  async processAuth(event) {
    ...
    try {
      ...
      if (
        ...
        this.authParms.authScheme1 === 'LDAP'
      ) {
...
LDAPCardPanelPage.contextTypes = {
  router: PropTypes.object.isRequired
};

LDAPCardPanelPage.propTypes = {
  classes: PropTypes.object.isRequired
};

export default withRoot(withStyles(styles)(LDAPCardPanelPage));
